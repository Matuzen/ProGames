...
namespace ProGames.Api.Mappings;
...
public static class MappingDtos
{
    ...
    {
        return (from carrinhoItem in carrinhoItens join produto in produtos on carrinhoItem.ProdutoId equals produto.Id select new CarrinhoItemDto
        {
            Id = carrinhoItem.Id,
